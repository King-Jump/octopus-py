...
class BinanceFutureExchangeTest(ExchangeFutureTest):
    def setUp(self):
        ...
        self.client = BnFutureClient(params, LOGGER)
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(BinanceFutureExchangeTest)
