...
class BifuFutureClient(BaseClient):
    ...
    def _post(self, path, payload: dict, headers: dict = None):
        if headers:
            return requests.post(url=f'{self.base_url}{path}', json=payload, headers=headers, timeout=5)
    ...
    def balance(self) -> dict:
        """ Response
        """
        path = '/api/v1/private/contract/account/getAccountAsset'
        headers = self._sign(path=path)
        res = self._get(path, headers=headers)
        return res.json()

    def set_leverage(self, symbol: str, margin_mode: str, leverage: int) -> dict:
        path = "/api/v1/private/contract/account/updateLeverageSetting"
        header = self._sign(path=path)
        ...
        res = self._post(path, payload, header)
        return res.json()

    def set_account(self, symbol: str, margin_mode: str, separated_mode: str, position_mode: str) -> dict:
        path = "/api/v1/private/contract/account/updateModeSetting"
        header = self._sign(path=path)
    ...
    def open_orders(self, symbol: str) -> list[OrderStatus]:
        """ get open orders
            ...
            {'code': 'SUCCESS',
             'data': {
                'dataList': [
                    {'id': '697616103848806073',
                     'accountId': '693456907909726649',
                      'coinId': '2',
                      'contractId': '10000009',
                      'marginMode': 'SHARED',
                      ...
                      'price': '1.67900',
                      'size': '15772.2',
                      'clientOrderId': '513970687093879811',
                      'type': 'LIMIT',
                      ...
                      'isCloseAllPosition': False,
                      'status': 'OPEN',
                      'matchSequenceId': '56203400',
                      'triggerTime': '0',
                      'triggerPriceTime': '0',
                      'triggerPriceValue': '0',
                      ...
                      'cumLiquidateFee': '0',
                      'cumRealizePnl': '0',
                      'createdTime': '1766324640235',
                      'updatedTime': '1766324640258'},
                    ],
                    'nextFlag': False,
                    'totals': 114},
                'msg': None,
                'params': None,
                'requestTime': '1766324640602',
                'responseTime': '1766324640604',
    ...
    def batch_make_orders(self, orders: list[NewOrder], symbol: str = '') -> list[OrderID]:
        """ Response:
            {'code': 'SUCCESS',
             'data': {
                'list': [
                    {'clientOrderId': '10N_1766324637515S1', 'successOrderId': '697616092503212729', 'errorDetail': {'code': None, 'msg': None}, 'success': True},
                    {'clientOrderId': '10N_1766324637518S2', 'successOrderId': '697616092503213753', 'errorDetail': {'code': None, 'msg': None}, 'success': True},
                    {'clientOrderId': '10N_1766324637517S1', 'successOrderId': '697616092503214777', 'errorDetail': {'code': None, 'msg': None}, 'success': True},
        ...
        if len(orders) <= BATCH_SIZE:
            ...
            headers = self._sign(path=path)
            res = requests.post(url=f'{self.base_url}{path}', param=body,
    ...
    def batch_cancel(self, order_ids: list, symbol: str = '') -> list[OrderID]:
        """ Response:
            {'code': 'SUCCESS',
             'data': {
                'cancelResultMap': {
                    '697616092503218873': 'SUCCESS',
                    '697616092503219897': 'SUCCESS',
                    '697616092503221945': 'SUCCESS',
                    '697616092503212729': 'SUCCESS_ORDER_CANCELED'}
                },
             'msg': None,
             'params': None,
             'requestTime': '1766324649688',
             'responseTime': '1766324649702',
